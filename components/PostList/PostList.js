...
export default class PostList extends React.Component {
    render() {
        return (
            <div id={'posts'} className={'min-w-full px-32 py-12 flex flex-1 flex-col justify-center items-center bg-home-main-light bg-gradient-to-b dark:bg-home-gray-900'}>
